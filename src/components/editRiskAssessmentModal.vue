    ...
    <div class="backdrop">
      <div class="myModal">
        ...
        <form>
          ...
          <button type="button" @click="$emit('closeModal3')" class="button2">Cancel</button>
        </form>
        </div>
...
export default {
  ...
  methods: {
    assignItemProps(item){
        console.log('item',item)
        this.selectedHazard = item.hazard,
        this.selectedInjury=item.consequence,
        this.severity=item.severity,
        this.probability=item.probability,
        this.risk=item.risk,
        this.selectedPeopleEffected=item.peopleEffected,
        this.selectedMitigation=item.mitigation,
        this.mitigatedSeverity=item.mitigatedSeverity,
        this.residualRisk=item.residualRisk
    },
  ...
  mounted() {
    ...
    this.getOptionsFromTable('hazards')
      .then((data) => {
        this.hazardOptions = data;
      });
    ...
    this.getOptionsFromTable('equipment')
      ...
      console.log('mounted')
        this.assignItemProps(this.item)
